...
#include "cnbiros_shared_navigation/ProximitySectorConfig.h"
...
class CostMapToProximitySector {
	...
	private:
		...
		void on_dynamic_reconfiguration(cnbiros_shared_navigation::ProximitySectorConfig &config, 
										uint32_t level);
    ...
    protected:
		...
		dynamic_reconfigure::Server<cnbiros_shared_navigation::ProximitySectorConfig> cfgserver_;
		dynamic_reconfigure::Server<cnbiros_shared_navigation::ProximitySectorConfig>::CallbackType f_;
